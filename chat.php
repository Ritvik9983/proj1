...
if(!empty($_SESSION["usr_id"])){
  ...
  $usr_sql = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM usrdata WHERE `usrid` = '{$_SESSION['usr_id']}'"));
}
else{
	?>
  <script>
  ...
  <?php
                							...
                							$sql = mysqli_query($conn, "SELECT * FROM usrdata WHERE usrid = '{$_SESSION['usr_id']}'");
					...
					<div class="container">
						<div class="inside">
							<div class="nav nav-tab menu">
								<button class="btn"><img class="avatar-xl" src="<?php echo "admin/".openssl_decrypt($row['usrphoto'], $cipher, $vector_initialize, $option, $encryption_key); ?>" alt="avatar"></button>
